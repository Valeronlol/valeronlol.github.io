...
Разработка спортивной платформы данных и обновлений результатов в реальном времени.

<br/>

Применяемые технологии: Node.js, ValKey, Kafka, PostgreSQL, AWS, React.js.
...
Разбиение бизнес-идей на небольшие задачи и распределение их по команде.<br/>
...
Создание процесса "Непрерывной доставки и интеграции", настройка процесса разработки. Настройка системы резервного копирования данных.

Разработка микросервисной архитектуры бэкенда для обеспечения работы мобильных приложений и панели управления.
...
Участие в разработке архитектуры фронтенд-приложения на Vue.js, а также модуля для чатов.
...
Обновление системы на более современные технологии: с php/apache/backbone на Vue/node/nginx.
...
Разработка приложений различного уровня сложности для аутсорс-компании sibers.ru
